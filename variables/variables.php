...
$datos_contacto = [
	"principal" =>[
		...
		"horario" => [
			"horario" => "Lunes a Viernes de 8:00 a.m. 12:00 m – 2:00 p.m. 6:00 p.m. - Sábados de 8:30 a.m. 12:30 p.m.",
...
$texto_quienes_somos = [
	...
	"reconocimientos" => [
		...
		"parrafos" => [
			...
			5 => "» Orden al Mérito del Subsidio Familiar 'Grado de Oro' (Comfenalco Santander).» Orden Ciudadano Meritorio categoria Gran Cruz Gobernación de Santander.",
			6 => "» Orden Ciudad de Bucaramanga al Merito Empresarial, Industrial y Comercial (Consejo de Bucaramanga).",
			7 => "» Orden de la Democracia Grado Cruz gran Oficial (Camara de Representantes)",
		],
	],
];
...
$texto_servicios = [
	"arrendamientos" => [
		...
		1 => "» Le cancelamos su renta, pague o no el arrendatario hasta que se produzca la entrega del inmueble, aún en el caso del proceso de restitución, el cual adelantamos por nuestra cuenta.",
		2 => "» Atendemos el pago de sus cuotas de amortización en las corporaciones o entidades de crédito.",
		3 => "» Cancelamos sus impuestos prediales, de valorización y servicios públicos mientras el inmueble se halle desocupado.",
		4 => "» Entregamos y recibimos sus inmubles previo inventario detallado.",
		5 => "» Cuidamos que a sus inmuebles se les hagan las reparaciones locativas necesarias, previa su autorización.",
		6 => "» Le aseguramos los pagos de servicios públicos y cuotas de administración, en la cuantía que nos indique.",
		7 => "» Publicitamos sus inmuebles para arrendarlos a la menor brevedad.",
		8 => "» Estudiamos la situación legal de su inmueble para mejorar su rentabilidad.",
		9 => "» Gestionamos y atendemos su crédito con el respaldo de su renta.",
		10 => "» Seleccionamos sus Arrendatarios, previo estudio de sus antecedentes, solvencia moral y económica.",
		11 => "» Suscribimos el correspondiente contrato de arrendamiento con sujeción a las normas legales.",
		],
	],
	"ventas" =>[
		"titulo" => "Ventas",
		...
		1 => "» Personalmente lo asesoramos en la adquisisción o venta de su inmueble, mediante visitas que realizamos en su compañía.",
		2 => "» Realizamos el estudio de títulos que le garanticen la legalidad de la negociación.",
		3 => "» Elaboramos la promesa de compra-venta y su respectiva minuta.",
		4 => "» Efectuamos el pago de impuestos.",
		5 => "» Gestionamos los correspondientes Paz y Salvos.",
		6 => "» Lo asesoramos y gestionamos sus créditos ante las Corporaciones o Entidades Bancarias.",
		7 => "» Con diligencia agilisamos la firma de la correspondiente escritura de compra-venta.",
		8 => "» Estudiamos la situación legal de su inmueble para mejorar su rentabilidad.",
		9 => "» Publicitamos su Inmueble con Efectividad.",
		],
	],
	"propiedad" =>[
