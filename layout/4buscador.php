<section id="buscador" class="d-flex flex-wrap">
    ...
    <div class="py-3 d-flex align-items-center col-12 col-lg-3 col-xl-3 titulo_buscador">
        <div class="container">
            <h2 class="text-center"> Encuentre su inmueble </h2>
        </div>
    </div>

    <div id="formulario" class="rounded-bottom py-3 d-flex flex-wrap align-items-center justify-content-center col-12 col-lg-9 col-xl-9 contenido_buscador">
